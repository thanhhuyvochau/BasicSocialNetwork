...
<html>
    ...
    <body oncontextmenu='return false' class='snippet-body'>
        <a class="" href="${pageContext.request.contextPath}/MainController?action=logout">Logout</a>
                ...
                <div class="col-md-12">
                    <div class="main-verification-input-wrap">
                        <ul>
                            ...
                            <li>If somehow, you did not recieve the verification email then <a href="${pageContext.request.contextPath}/MainController?action=resend">resend the verification email</a></li>
                        </ul>
                        <div class="main-verification-input fl-wrap">
                            <div class="main-verification-input-item">
                                <form id="verify-form" action="${pageContext.request.contextPath}/MainController?action=verify" method="POST">
