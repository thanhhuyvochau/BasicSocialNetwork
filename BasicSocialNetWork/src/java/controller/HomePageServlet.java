...
public class HomePageServlet extends HttpServlet {
    ...
    final static String SUCCESS = "/view/homepage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Vector<Article> arList = arService.loadAllArticleByStatus(page);
        if (arList.size() == 0) {
            request.setAttribute("message", "Not found any post");
        }
